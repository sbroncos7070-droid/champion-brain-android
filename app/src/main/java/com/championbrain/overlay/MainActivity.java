...
public class MainActivity extends AppCompatActivity {
    ...
    private LinearLayout buildScreen() {
        ...
        Button start = new Button(this); start.setText("Start overlay assistant"); start.setAllCaps(false); start.setTextSize(18); start.setOnClickListener(v -> startFlow()); root.addView(start, new LinearLayout.LayoutParams(-1, 58));
